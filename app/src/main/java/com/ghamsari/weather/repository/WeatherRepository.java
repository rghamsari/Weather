...
public class WeatherRepository {
    ...
    public LiveData<List<WeatherDto>> getLocationWeatherDitel (String lot ,String lon) {
        jsonPlaceHolderApi.getWeather(lot, lon, "metric", "6ff87ae2cecff28bf3919d0106f692fb").subscribeOn(Schedulers.io()).
